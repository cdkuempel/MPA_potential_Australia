...
strict_imcra_adjusted<- st_read(here("output_data/IMCRA_intersect_adjust/strict_imcra_adjusted_2003.shp"))%>% 
  filter(!is.na(Year) == TRUE)
...
non_strict_imcra_adjusted<- st_read(here("output_data/IMCRA_intersect_adjust/non_strict_imcra_adjusted_2003.shp"))%>% 
  filter(!is.na(Year) == TRUE)
...
capad_imcra_adjusted<- st_read(here("output_data/IMCRA_intersect_adjust/capad_imcra_adjusted_2003.shp"))%>% 
  filter(!is.na(Year) == TRUE)
...
years<-min(capad_imcra_adjusted$Year):2003
...
years<-min(strict_imcra_adjusted$Year):2003
...
years<-min(non_strict_imcra_adjusted$Year):2003
