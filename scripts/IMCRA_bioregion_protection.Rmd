...
st_write(imcra_diss, here("output_data/IMCRA_diss.shp"))
```

```{r}
imcra_diss <- st_read(here("output_data/IMCRA_diss.shp"))
...
plot(st_read(here("output_data/Capad_adjusted/capad_adjust_2007.shp")))
```
