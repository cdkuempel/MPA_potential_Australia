...
view(st_read(here("output_data/IMCRA_intersect/Non_strict_imcra_intersect.shp")))
...
view(st_read(here("output_data/IMCRA_intersect_adjust/Adjust_non_strict_imcra_intersect.shp")))
